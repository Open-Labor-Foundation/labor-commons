...
- Enable routing behind education-compliance queue controls with explicit onboarding-checklist output on each compliant request.
...
- Track:
  ...
  - missing consent/assessment evidence escalations,
