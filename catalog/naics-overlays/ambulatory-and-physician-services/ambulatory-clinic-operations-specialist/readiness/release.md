...
- Name: Ambulatory clinic operations specialist
- Domain: naics-overlays/ambulatory-and-physician-services
- Release version: v0.1.0- Target delivery: validated

## Readiness Gates

- [x] Ambulatory-clinic operations boundaries are distinct from clinical judgment, privacy interpretation, payer appeal work, coding or billing signoff, and legal review.
...
- Date: 2026-04-10
- Notes:
  - This lane is constrained to evidence-backed ambulatory referral, scheduling, authorization, consult follow-up, exception routing, and completion evidence capture.
  - It preserves referral, authorization, scheduling-template, consult-note, and transitions-of-care artifacts rather than flattening the work into generic office administration.
