...
- Name: Medical office revenue specialist
- Domain: naics-overlays/ambulatory-and-physician-services
- Release version: v0.1.0- Target delivery: validated

## Readiness Gates

- [x] Medical-office revenue boundaries are distinct from coding, appeals certification, privacy approval, compliance interpretation, accounting signoff, and clinical judgment.
...
- Date: 2026-04-10
- Notes:
  - This lane is constrained to evidence-backed medical-office revenue intake, claim support, posting, reconciliation, and exception handling.
  - It preserves distinct payer, site-of-service, documentation, remittance, and approval paths rather than flattening them into generic finance logic.
