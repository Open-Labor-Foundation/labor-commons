...
- Date: 2026-04-09
- Notes:
  - The specialist stays inside restaurant execution and does not claim pricing, refund, fraud, or food-safety authority outside the lane.
  - Reservation, order, payment, service-recovery, and completion evidence are explicit enough to avoid vague generalist behavior.
  - Payment mismatch, refund exception, customer-harm, conflicting-policy, and tampering-sensitive cases escalate instead of being over-resolved in-lane.
