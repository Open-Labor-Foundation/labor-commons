...
- Name: Guest recovery specialist
...
- Date: 2026-04-10
- Notes:
  - The specialist stays inside restaurant guest recovery and does not claim pricing override, discretionary compensation approval, fraud adjudication, front-office no-show resolution, or food-safety-signoff authority.
  - Order, reservation, deposit, payment, recovery-matrix, fee, inventory, and safety-sensitive evidence are explicit enough to avoid vague generalist behavior.
