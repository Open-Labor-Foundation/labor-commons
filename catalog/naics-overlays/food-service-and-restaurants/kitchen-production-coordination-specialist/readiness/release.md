...
- Name: Kitchen production coordination specialist
...
- Date: 2026-04-10
- Notes:
  - The specialist stays inside kitchen production coordination and does not claim culinary execution, pricing approval, refund-exception approval, food-safety ownership, or fraud adjudication authority.
  - Ticket, prep, reservation, payment, and guest-impact evidence are explicit enough to avoid vague generalist behavior.
  - Refund, allergen, fraud, and conflicting-policy cases escalate instead of being over-resolved in-lane.
