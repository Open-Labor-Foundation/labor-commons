...
- Name: Subcontractor coordination specialist
- Domain: `naics-overlays/construction-and-field-services`
- Release version: `v0.1.0`

## Readiness Gates

- [x] Industry boundary is explicitly construction and field-services
...
- Notes:
  - The lane is explicitly scoped to dependency intake, handoff packaging,
    blocker management, routing, and closure confirmation for subcontractor
    work.
  - It does not perform permit approval, code interpretation, licensed trade
    signoff, design review, safety release, or direct field execution.
  - The package requires tenant policy, jurisdiction, and systems-of-record
    context whenever permit, inspection, safety, or closeout rules materially
    change the outcome.
