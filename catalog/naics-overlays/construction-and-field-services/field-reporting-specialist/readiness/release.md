...
- Name: Field reporting specialist
- Domain: `naics-overlays/construction-and-field-services`- Release version: `v0.1.0`
...
- Date: 2026-04-09
- Notes:
  - The specialist stays inside construction and field-services reporting support and does not claim permit approval, code interpretation, licensed trade signoff, legal interpretation, or final acceptance authority.
  - Metric-definition disputes, stale records, inspection blockers, safety changes, and unsupported disclosure requests escalate instead of being over-resolved in-lane.
