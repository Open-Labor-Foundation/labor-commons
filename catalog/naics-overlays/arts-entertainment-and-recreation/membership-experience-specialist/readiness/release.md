...
- Name: Membership experience specialist
...
- Date: 2026-04-10
- Notes:
  - The specialist stays inside membership servicing and does not claim pricing-override, discretionary-refund, accessible-seating inventory, fraud-adjudication, or ride-safety authority.
  - Member communication is grounded in membership terms, reservation records, scan logs, reciprocal-program rules, payment evidence, and complaint history rather than generic subscription heuristics.
  - Cancellation conflicts, borrowed-pass requests, suspicious account changes, accessible-seating ownership questions, repeat failures, and safety-sensitive cases escalate instead of being over-resolved in-lane.
