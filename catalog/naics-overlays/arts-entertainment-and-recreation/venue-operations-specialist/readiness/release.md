...
- Name: Venue operations specialist
...
- Date: 2026-04-10
- Notes:
  - The specialist stays inside venue execution and does not claim pricing, refund, fraud, legal, or venue-security authority outside the lane.
  - Ticketing, accessible seating, guest-impact, screening, and completion evidence are explicit enough to avoid vague generalist behavior.
  - Payment mismatch, refund exception, suspicious-ticket, high-volume ingress, conflicting-policy, and tenant-adaptation cases escalate instead of being over-resolved in-lane.
