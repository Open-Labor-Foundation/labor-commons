...
- Name: Event production specialist
...
- Date: 2026-04-10
- Notes:
  - The specialist stays inside live-event production execution and does not claim pricing, refund, fraud, permit-override, or public-safety command authority outside the lane.
  - Permit, event-map, run-of-show, ticketing, payment, public-safety, and completion evidence are explicit enough to avoid vague generalist behavior.
  - Ticket mismatch, refund exception, customer-harm, suspicious-access, and conflicting-policy cases escalate instead of being over-resolved in-lane.
