# Deployment Package: Reservations specialist

## Package Identity

- Queue slug: `industry-overlays::hospitality-and-travel::reservations-specialist`
- Package path: `catalog/naics-overlays/hospitality-and-travel/reservations-specialist/`
...
commercial packaging for reservation readiness work in hospitality
...
- Reservation request identity, sponsor or payer, stay or travel dates,
  arrival/departure pattern, origin/destination, room type or booking class,
  rate plan, reservation inventory, traveler or guest roster, itinerary and
  service requirements, accessible accommodation needs, travel assistance
  needs, hold/ticketing/cut-off/release dates, deposit status, cancellation
  and change context, booking channel, and owner matrix
...
- Systems-of-record inventory and retrieval hooks for PMS, CRS, GDS, booking
  engine, OTA/channel manager, reservation operations, reservation CRM, travel management, payment/deposit,
...
- The lane is administrative and operational. It validates readiness for
  reservation intake but does not make clinical, payer, privacy-release,
...
- The request requires diagnosis, treatment planning, clinical urgency,
  ...
  cancellation waiver, safety clearance, or executive policy override.
...
4. Re-route new reservation intake to the nearest existing
...
- Tenant connectors and retrieval scopes are approved for the required PMS,
  CRS, reservation CRM, reservation operations, travel management, EHR/EMR, payer portal,
