...
- The manifest defines a hospital-specific hospital-patient-throughput boundary for ADT,
  encounter, throughput-board, staffed-bed and care-team, unit, isolation, EVS, transport, equipment,
...
- Tenant source-of-truth hierarchy, unit taxonomy, priority matrix, surge rules,
  transfer-center workflow, isolation room map, staffed-bed and care-team policy, and approval
...
`industry-overlays::hospitals-and-health-systems::hospital-patient-throughput-specialist`.
The package supports recommendation-quality throughput demand, capacity, sequencing,
