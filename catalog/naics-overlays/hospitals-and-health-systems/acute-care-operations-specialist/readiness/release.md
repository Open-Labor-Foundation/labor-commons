...
- Name: Acute care operations specialist
...
- [x] Specialty boundary is explicit for acute care operational case progression inside hospitals and health systems.
- [x] Owned artifacts include EHR/EMR encounters, ADT status, orders, clinical-administrative notes, discharge and transition records, eligibility, benefits, referral, authorization, charge capture, coding, claim, remittance, denial, and appeal evidence.
- [x] Clinical, utilization, payer, privacy, coding, revenue-cycle, legal, financial approval, and patient-safety handoff boundaries are documented.
...
- Date: 2026-04-14
- Notes: Package satisfies issue #1444 with a validated, evidence-backed, specification-based acute care operations overlay. Tenant runtime must still supply facility policy, care setting, payer and plan context, source hierarchy, RACI, system retrieval hooks, privacy controls, authorization/referral/eligibility rules, and adjacent owner routes before operational action.
