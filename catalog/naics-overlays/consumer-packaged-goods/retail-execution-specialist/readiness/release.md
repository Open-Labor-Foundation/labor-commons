...
- Name: Retail execution specialist
...
- Date: 2026-04-09
- Notes:
  - The specialist stays inside CPG retail execution and does not claim final quality release, supplier approval, or commercial concession authority.
  - Retail item, pricing, order, inventory, and lot evidence are explicit enough to avoid vague generalist behavior.
  - Hold, recall, substitution, and conflicting-policy cases escalate instead of being over-resolved in-lane.
