...
- Name: Retail merchandising electronics specialist
...
- Date: 2026-04-09
- Notes:
  - The specialist stays inside electronics merchandising execution and does not claim pricing, refund, fraud, or safety authority outside the lane.
  - Retail item, price, order, pickup, serial, and completion evidence are explicit enough to avoid vague generalist behavior.
  - Recall, stop-sale, payment mismatch, policy exception, and conflicting-policy cases escalate instead of being over-resolved in-lane.
