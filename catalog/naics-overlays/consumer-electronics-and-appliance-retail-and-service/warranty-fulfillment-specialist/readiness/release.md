...
- Name: Warranty fulfillment specialist
...
- Date: 2026-04-09
- Notes:
  - The specialist stays inside dealer warranty and product-service execution and does not claim refund approval, legal interpretation, recall command, or fraud-investigation authority.
  - Proof-of-purchase, model and serial, service-order, parts, and completion evidence are explicit enough to avoid vague generalist behavior.
  - Safety, refund-exception, and conflicting-policy cases escalate instead of being over-resolved in-lane.
