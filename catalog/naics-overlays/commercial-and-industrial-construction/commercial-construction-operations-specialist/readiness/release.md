...
- Name: Commercial construction operations specialist
...
- [x] Evaluation suite covers required workflow and commercial-construction-specific scenarios.
...
- Date: 2026-04-09
- Notes:
  - The lane stays narrow to commercial construction execution-state handling, prerequisite validation, rework and exception management, completion-evidence review, and escalation packaging.
  - It does not claim permit approval, code interpretation, occupancy approval, licensed trade judgement, engineering signoff, inspection authority, change-order approval, or direct field execution.
