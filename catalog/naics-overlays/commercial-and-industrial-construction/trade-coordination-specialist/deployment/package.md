...
- Tenant-supplied runtime context:
  ...
  - PMIS, field-service, permitting, inspection, safety, and closeout system
    connectors;
  - tenant-specific turnover, occupancy, and destination-acceptance rules;
...
- Required task and boundary metadata:
  ...
  - authority-boundary map for permit approval, code interpretation, licensed
    trade signoff, engineering review, safety release, occupancy approval, and
...
- The lane must record:
  ...
  - permit, inspection, safety, occupancy, and closeout dependency status.
- Regulated-lane caveats:
  - do not imply permit approval, AHJ authority, occupancy approval, code
...
- Observability requirements:
  ...
  - permit, inspection, safety, occupancy, and closeout gate outcomes.
...
- Promote this overlay to a retained implementation only after:
  ...
  - production reviews show safe handling of permit, inspection, safety,
    occupancy, and closeout boundaries,
