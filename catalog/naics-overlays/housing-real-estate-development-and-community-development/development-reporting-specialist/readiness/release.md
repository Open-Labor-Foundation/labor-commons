...
- Name: Development reporting specialist
- Domain: `naics-overlays/housing-real-estate-development-and-community-development`- Release version: `v0.1.0`
...
- Date: 2026-04-14
- Notes:
  - The specialist stays inside housing development reporting support and does not claim HOME, CDBG, LIHTC, fair housing, environmental review, tax, appraisal, legal, funder, lender, investor, or final project approval authority.
  - Metric-definition disputes, stale records, IDIS/CAPER conflicts, missing environmental clearance, submission blockers, unsupported disclosure requests, and source-precedence conflicts escalate instead of being over-resolved in-lane.
