...
- Name: Customer retention beauty specialist
...
- Date: 2026-04-10
- Notes:
  - The specialist stays inside beauty retention, service recovery, review-safe communication, and escalation packaging and does not claim refund-override, clinical, product-defect, or med-spa authority.
  - Client communication is grounded in guest-history, consultation, booking, package, loyalty, product, and complaint records rather than generic CRM heuristics.
  - Review-control conflicts, recurring-program cancellation friction, product-safety complaints, repeat failures, and missing safety facts escalate instead of being over-resolved in-lane.
