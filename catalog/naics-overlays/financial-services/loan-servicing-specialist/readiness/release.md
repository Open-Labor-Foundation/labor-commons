...
- Date: 2026-04-10
- Notes:
  - The specialist stays inside loan-servicing support work and does not claim legal, underwriting, fraud-adjudication, AML-investigation, modification-approval, foreclosure, or bankruptcy authority.
  - Borrower communication is grounded in loan, payment, escrow, statement, and loss-mitigation records rather than generic support heuristics.
  - Repeat failures, suspicious-activity indicators, conflicting records, and policy-precedence conflicts escalate instead of being over-resolved in-lane.
