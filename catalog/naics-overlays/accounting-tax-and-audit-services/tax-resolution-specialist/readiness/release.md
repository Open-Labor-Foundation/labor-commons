...
- [x] Required abilities for `service-support-and-resolution` + `professional-and-information-services` are present
...
- Date: 2026-04-10
- Notes:
  - The package distinguishes tax-resolution operations from tax advice, written tax advice, legal interpretation, taxpayer representation, settlement negotiation, financial approval, client approval, and contractual signoff.
