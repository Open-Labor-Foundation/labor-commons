...
- Name: Client accounting services specialist
- Domain: `naics-overlays/accounting-tax-and-audit-services`- Release version: `v0.1.0`
...
- Date: 2026-04-10
- Notes:
  - The specialist stays inside client accounting service work and does not claim tax, audit, advisory, legal, contractual, or management-approval authority.
  - Client communication is grounded in engagement scope, close records, ERP extracts, reconciliations, workpapers, review notes, and confidentiality controls.
  - Missing evidence, repeat failure, policy exception, confidentiality conflict, and source-policy conflict cases escalate instead of being over-resolved in-lane.
