...
- Name: AWS architecture specialist
- Domain: Cloud Platform And Infrastructure
- Release version: v0.2.0
- Issue: #1633
## Readiness Gates

- [x] Specialty boundary is explicit and AWS-architecture specific.
...
- Reviewer: john
- Date: 2026-04-14
- Notes: Issue #1633 is satisfied as a refreshed spec-first AWS architecture specialist package. The pack preserves the legacy high-value AWS architecture boundary, replaces generic assumptions with research-backed workflow and evidence definitions, and remains `specification-based` until a separate frequent-use trusted-build promotion is approved.
