...
- Name: Franchise onboarding specialist
...
- Date: 2026-04-10
- Notes:
  - The lane stays inside franchise onboarding readiness and does not claim legal, financing, permitting, or steady-state operations authority.
  - Franchise-specific records such as FDD receipt, state addenda, Item 11 training, Item 23 receipt trail, IAM approvals, and opening-checklist milestones are explicit enough to avoid vague generalist behavior.
  - Go-live, access, and disclosure conflicts escalate instead of being over-resolved in-lane.
