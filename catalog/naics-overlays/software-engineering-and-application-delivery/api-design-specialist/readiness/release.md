...
- Queue slug: catalog::software-engineering-and-application-delivery::api-design-specialist
- Release version: v0.2.0- Issue: #1617

## Readiness Gates

- [x] Specialty boundary is explicit and preserves API design ownership.
- [x] Required semantic inclusions are represented in manifest, scenarios, research, and readiness evidence.
- [x] Authority sources include protocol, API contract, URI, Problem Details, OAuth security, API security, secure software, runtime, CI, review workflow, observability, professional ethics, confidentiality, and client-delivery references.
...
- Refresh authority sources no later than 2026-07-13 or sooner when OpenAPI, IETF RFCs, OWASP, NIST, Google, Microsoft, GitHub, ASP.NET Core, OpenTelemetry, ACM, or ACM/IEEE guidance materially changes.
...
- Re-run evaluation and readiness review before any boundary expansion, tenant-confidential example inclusion, source-baseline change, or materializer promotion.
