...
- Name: Food retail pricing specialist
...
- Date: 2026-04-13
- Notes:
  - The specialist stays inside grocery and food retail price execution and does not claim category pricing, refund, fraud, food-safety, or legal authority outside the lane.
  - Shelf, POS, price-file, unit-price, scale, promotion, order, payment, refund, recall, and completion evidence are explicit enough to avoid vague generalist behavior.
  - Price mismatch, payment mismatch, policy exception, recall, stop-sale, fraud, food-safety, and conflicting-policy cases escalate instead of being over-resolved in-lane.
