...
- Name: Grocery e-commerce specialist
...
- Date: 2026-04-13
- Notes:
  - The specialist stays inside grocery e-commerce execution and does not claim pricing, refund, SNAP, fraud, food-safety, recall, or legal authority outside the lane.
  - Grocery order, basket, item, weighted-price, substitution, payment, staging, pickup or delivery, and completion evidence are explicit enough to avoid vague generalist behavior.
  - Payment mismatch, SNAP-sensitive refund, pricing override, food-safety complaint, fraud signal, conflicting-policy, recall, and allergen cases escalate instead of being over-resolved in-lane.
