...
- Name: Broadcast scheduling specialist
...
- Date: 2026-04-10
- Notes:
  - The lane stays narrow to recommendation-only broadcast scheduling, prerequisite validation, capacity analysis, sequence support, booking readiness, and escalation packaging.
  - It does not claim final programming approval, rights interpretation, labor or child-performer compliance authority, caption-waiver approval, editorial signoff, or master-control release authority.
