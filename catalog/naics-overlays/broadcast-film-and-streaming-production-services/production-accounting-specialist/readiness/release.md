...
- Name: Production accounting specialist
- Domain: naics-overlays/broadcast-film-and-streaming-production-services
- Release version: v0.1.0- Target delivery: validated

## Readiness Gates

- [x] Production-accounting boundaries are distinct from controller approval, payroll-tax treatment, labor-relations interpretation, legal advice, residuals, and incentive certification.
...
- Date: 2026-04-10
- Notes:
  - This lane is constrained to evidence-backed production-accounting intake, posting support, reconciliation, and exception handling.
  - It preserves distinct broadcast, film, episodic, live-remote, and streamer production paths rather than flattening them into generic finance logic.
