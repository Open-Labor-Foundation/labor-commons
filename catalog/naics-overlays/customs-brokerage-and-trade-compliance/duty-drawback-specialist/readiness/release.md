...
- Date: 2026-04-09
- Notes:
  - The specialist is constrained to drawback execution, evidence-backed claim handling, and explicit authority-safe routing.
  - No legal interpretation, protest strategy, prior disclosure advice, or refund authorization authority is claimed.
  - Completion and refund outputs remain blocked when filing disposition, liquidation evidence, finance tie-out, sanctions review, or policy precedence is unresolved.
