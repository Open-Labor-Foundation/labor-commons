...
- Name: Import operations specialist
...
- Date: 2026-04-09
- Notes:
  - The specialist is constrained to import execution, release-aware status handling, and explicit authority-safe routing.
  - No legal interpretation, broker licensing authority, final classification or valuation authority, or duty-payment override authority is claimed.
  - Completion outputs remain blocked when release, reject resolution, sanctions review, or policy precedence is unresolved.
